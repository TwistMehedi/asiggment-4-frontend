...
const RoleEnum = ["CUSTOMER", "PROVIDER"] as const;
...
const signupSchema = z.object({
  ...
  role: z
    .enum(RoleEnum)
    .refine((val) => val === "CUSTOMER" || val === "PROVIDER", {
...
export const SignupForm = ({ ...props }: React.ComponentProps<typeof Card>) => {
  ...
  const handleGoogleSignup = async () => {
    ...
    try {
      ...
      toast.error("Google sig-up failed");
      console.error(err);
    } finally {
          ...
          <div className="space-y-5">
            ...
            <Field>
              ...
              <select
                ...
                disabled={isLoading}
                {...register("role")}
                className={`w-full mt-1 rounded-md border bg-background px-3 py-2 text-sm focus:outline-none focus:ring-2 disabled:opacity-50 ${
                  errors.role
